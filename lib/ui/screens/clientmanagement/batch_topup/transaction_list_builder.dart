...
//
// import '../../../shared/widget/containers/transaction_items.dart';
//
// // // Sample Data
// // final data = {
// //   "failed": [
...
//                 itemCount: data['success']?.length ?? 0,
//                 itemBuilder: (context, index) {
//                   var item = data['success']![index];
//                   return Padding(
...
//               ),
//               child: ListView.builder(
//                 itemCount: data['failed']?.length ?? 0,
//                 itemBuilder: (context, index) {
//                   var item = data['failed']![index];
//                   return Padding(
//                     padding: EdgeInsets.only(bottom: 10),
//                     child: TransactionItem(
//                       customerName: item['creditCustomerName'] ?? '',

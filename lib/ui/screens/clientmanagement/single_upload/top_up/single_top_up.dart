...
//     double amount = double.tryParse(singleTopUpAmount.text) ?? 0; // Ensure to replace with your actual amount input
//
//     // Show loading dialog
//     showDialog(
//       context: context,
...
//               context,
//               () => singleTopUpAmount.text.isNotEmpty
//                   ? singleTopUpAmount.text == '0'
//                       ? null
...
//           //       //     double amount = double.tryParse(singleTopUpAmount.text)!;
//           //       //
//           //       //     return SizedBox(
//           //       //       width: 160,
//           //       //       height: 50,
...
//   }
//
//   ///STEPPER 1: E-WALLET INFORMATION
...
//                   child: Row(
//                     mainAxisAlignment: MainAxisAlignment.center,
//                     children: [CustomColoredButton.secondaryButtonWithText(context, 5, () => Navigator.pop(context), AppColors.bgColor, 'Cancel'), CustomColoredButton.primaryButtonWithText(context, 5, () => _onTopUpPressed(), AppColors.infoColor, 'Confirm')],
//                   ),
//                 ),
//               ),

...
import 'package:mfi_whitelist_admin_portal/ui/screens/clientmanagement/client_list/pending_clients.dart';
...
import 'approve_disapprove/approved_disapproved_actions.dart';

class PendingClients extends StatefulWidget {
  const PendingClients({super.key});

  @override
  State<PendingClients> createState() => _PendingClientsState();
}

class _PendingClientsState extends State<PendingClients> {
  final buildColumnItems = ['File Name', 'Date and Time Uploaded', 'Maker', 'Checker', 'Status', 'Remarks', 'Date Updated', 'Actions'];
  final role = getUrole();
  ...
  void initState() {
    super.initState();
    MFIClientProvider userRows = Provider.of<MFIClientProvider>(context, listen: false);
    userRows.fetchAllFiles();
    refreshTableData();
    updateUrl('/Access/Client_List/Uploaded_Clients');
  ...
  void _onSearchChanged() {
    ...
    Provider.of<MFIClientProvider>(context, listen: false).searchFromFile(query);
  }
  ...
  void _updatePageSize(int value) {
    ...
    Provider.of<MFIClientProvider>(context, listen: false).updatePageSize(value);
  }
      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const HeaderBar(screenText: 'UPLOADED FILES'),
              const HeaderCTA(children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Uploaded Files', style: TextStyles.heavyBold16Black),
                    Text(
                      'Manage files for MFI client whitelisting.',
  ...
  Widget paginationControls() {
    return Consumer<MFIClientProvider>(
  ...
  Widget userTable() {
    return Container(
      ...
      child: Consumer<MFIClientProvider>(builder: (context, userProvider, _) {
        if (userProvider.currentUsers.isEmpty) {
          ...
          List<AllUploadedFileData> userRows = userProvider.currentUsers;
            ...
            child: DataTableTheme(
              ...
              child: DataTable(
                ...
                rows: userRows.asMap().entries.map((entry) {
                  ...
                  final AllUploadedFileData userManagement = entry.value;
                  ...
                  return DataRow(
                    ...
                    cells: [
                      ...
                      DataCell(Text(userManagement.checker ?? '')),
                      DataCell(
                        Row(
                          children: [
                            Container(
                            ...
                            SizedBox(
                              ...
                              child: CustomColoredButton.primaryButtonWithText(
                                  ...
                                  () => showGeneralDialog(
                                        ...
                                        pageBuilder: (context, animation, secondaryAnimation) => PendingClientPerFile(
                                          fileName: userManagement.fileName!,
                                          batchID: userManagement.batchUploadId!,
                            ...
                            Tooltip(
                              ...
                              child: InkWell(
                                onTap: userManagement.status?.toUpperCase() == 'DISAPPROVED' || userManagement.status?.toUpperCase() == 'PENDING'
                                    ...
                                    : null,
                                child: Icon(Icons.delete, color: userManagement.status?.toUpperCase() == 'DISAPPROVED' || userManagement.status?.toUpperCase() == 'PENDING' ? AppColors.maroon4 : Colors.grey, size: 20),
                              ),
                            ),
                            const SizedBox(width: 5),
                            Tooltip(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  debugPrint('ID to download ${batchUploadID.toString()}');
                                  showDownloadButtonAlertDialog(userManagement.fileName!, () async {
                                    await ClientActions.downloadClients(batchUploadID, file, refreshTableData);
                                  });
                                },
                              ),
                            ),

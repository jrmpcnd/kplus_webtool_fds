...
class ClientActions {
  ...
  static Future<void> downloadClients(int batchUploadID, String filename, Function() onSubmission) async {
    // Show loading dialog
    showDialog(
      context: navigatorKey.currentContext!,
      barrierDismissible: false,
    ...
    final downloadingResponse = await DownloadClientListAPI.downloadClientList(batchUploadID, filename);
...
void showResponseAlertDialog({required bool isSuccess, String? successMessage, String? failureMessage, required Function() onSuccessSubmission}) {
  showDialog(
    context: navigatorKey.currentContext!,

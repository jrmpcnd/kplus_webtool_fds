...
class DisapprovedClients extends StatefulWidget {
  const DisapprovedClients({Key? key}) : super(key: key);

  @override
  State<DisapprovedClients> createState() => _DisapprovedClientsState();
}

class _DisapprovedClientsState extends State<DisapprovedClients> {
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            const HeaderBar(screenText: 'DISAPPROVED CLIENTS'),
            Container(

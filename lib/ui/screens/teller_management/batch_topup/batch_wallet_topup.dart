...
import 'package:mfi_whitelist_admin_portal/ui/screens/teller_management/batch_topup/batch_topup_body.dart';
...
class WalletBatchUpload extends StatefulWidget {
  const WalletBatchUpload({Key? key}) : super(key: key);

  @override
  State<WalletBatchUpload> createState() => _WalletBatchUploadState();
}

class _WalletBatchUploadState extends State<WalletBatchUpload> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    updateUrl('/Access/Top_Up/Batch_Top_Up');
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            const HeaderBar(screenText: 'BATCH WALLET TOP UP'),

...
class OtpLogs extends StatefulWidget {
  const OtpLogs({Key? key}) : super(key: key);

  @override
  State<OtpLogs> createState() => _OtpLogsState();
}

class _OtpLogsState extends State<OtpLogs> {
  // Timer? _timer;
  //
  // void _startTimer() {
  ...
  void fetchData(int page, int perPage) async {
    ...
    try {
      ...
      final response = await http.get(
        ...
        // Uri.parse('https://dev-mercury.fortress-asya.com:17000/api/v1/report/otp?page=$page&perPage='),
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            const HeaderBar(screenText: 'OTP LOGS'),
            Container(
              ...
              children: [
                Container(
                  ...
                  child: IconButton(
                    ...
                    // color: const AppColors.ngoColor,
                    color: Colors.white,
